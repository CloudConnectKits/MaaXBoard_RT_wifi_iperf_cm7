...
pin_labels:
- {pin_num: N3, pin_signal: GPIO_EMC_B2_18, label: USER_LED, identifier: SEMC_DQS4;USER_LED}
...
- pin_list:
  ...
  - {pin_num: N3, peripheral: GPIO8, signal: 'gpio_io, 28', pin_signal: GPIO_EMC_B2_18, identifier: USER_LED, direction: OUTPUT, gpio_init_state: 'true'}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of USER_LED on GPIO_EMC_B2_18 (pin N3) */
  ...
  GPIO_PinInit(GPIO8, 28U, &USER_LED_config);
